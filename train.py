...
if __name__ == "__main__":
    ...
    fp16            = False
    #---------------------------------------------------------------------#
    #   classes_path    对应数据集的类别文档
    #---------------------------------------------------------------------#
    classes_path    = 'model_data/dota_voc.txt'
    #---------------------------------------------------------------------#
    #   用于选择所使用的模型的版本，0-7
    #---------------------------------------------------------------------#
    phi             = 0
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path      = 'model_data/Pre-training-weight-parameters.pth'
    #------------------------------------------------------#
    ...
    #------------------------------------------------------------------#
    #   Init_lr         模型的最大学习率
    #                   当使用Adam优化器时  Init_lr=3e-4
    #                   当使用SGD优化器时  Init_lr=1e-2
    ...
    if distributed:
        ...
        local_rank      = 0
        rank            = 0
    if classes_path    != 'model_data/voc_classes.txt':
